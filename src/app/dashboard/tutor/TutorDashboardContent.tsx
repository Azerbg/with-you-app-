          ...
          <div className="grid xl:grid-cols-3 gap-6">
            ...
            <div className="space-y-4">
              ...
              <Link href="/dashboard/tutor/earnings"
                className="flex items-center gap-3 bg-white rounded-2xl border border-black/5 px-5 py-4 hover:bg-[#FFFBEA] transition group">
                <div className="w-8 h-8 rounded-xl bg-[#FFF3B0] text-[#C49200] flex items-center justify-center flex-shrink-0">
